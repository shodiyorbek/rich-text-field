...
import { 
    ...
    MdFormatQuote, MdFormatAlignLeft, MdFormatAlignCenter, MdFormatAlignRight, 
    MdFormatListNumbered, MdFormatListBulleted, MdInsertLink, MdVideoLibrary, 
    MdImage, MdAdd, MdKeyboardArrowRight, MdArrowForward, MdFormatAlignJustify 
} from 'react-icons/md';
import { BsTypeH1, BsTypeH2, BsTypeH3, BsCameraVideoFill } from 'react-icons/bs';
import { FaSuperscript, FaSubscript } from 'react-icons/fa';
import { 
    AiFillEdit, AiOutlineTable, AiOutlineInsertRowBelow, AiOutlineInsertRowRight,
    AiOutlineDelete, AiFillTag, AiOutlineUpload, AiOutlineArrowsAlt, 
    AiOutlineInsertRowAbove, AiOutlineInsertRowLeft, AiFillHtml5 
} from 'react-icons/ai';
